  ...
  return (
    <section className="relative w-full my-10">
      ...
      >
        {/* Desktop Image */}
        <img
          src="https://images.grownbrilliance.com/general_images/homeimg/home_banner_256_01272026121440.png"
        ...
        {/* Mobile Image */}
        <img
          src="https://images.grownbrilliance.com/general_images/homeimg/home_mobile_banner_256_01272026121440.png"
          alt="Complimentary Diamond Stud Earrings"
